...
All 27 phases complete. `go test -race -count=1 ./...` → 1111 tests pass across 23 packages. Smoke demos: cluster (25/25), repl (16/16), repl-restart (16/16), repl-auto (24/24).
...
- Phase 27 net-new test accounting: 47 (`background_sync_test.go`) + 26 (`replication_phase27_test.go`) + 14 (`server_lifecycle_test.go`) + 1 (`replicator_test.go#PrimaryLatestSeq_Reported`) = 88 (not 72)
